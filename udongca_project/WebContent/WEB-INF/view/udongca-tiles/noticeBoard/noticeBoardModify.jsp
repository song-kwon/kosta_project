...
<form class="form2" action="/udongca_project/noticeBoard/modifyNoticeBoard.udc?noticeNo=${requestScope.map.noticeBoard.noticeNo}" method="post" onsubmit="return checkSubmit();">
<table>
	<tr>
