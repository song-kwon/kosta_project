...
<script type="text/javascript">
	...
	function menuAdd(){
		$("#menuList").append("<hr><div class='menu" + menuId + "' style='padding-bottom:20px;'><input type='hidden' name='menuNOArray' value='0'><b>종류 :</b> <select name='menuTypeArray' class='form-control'><option>종류</option></select>" + "<br><b>이름 :</b> <input type='text' name='menuNameArray' class='form-control'>" + "<br><b>사진 :</b> <input type='file' name='menuImageArray'><br>" + "<input type='button' value='메뉴 삭제' onclick='menuDelete(" + menuId + ")' class='btn btn-default'></div>");
