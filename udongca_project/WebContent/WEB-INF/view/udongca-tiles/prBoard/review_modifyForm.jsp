...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		for(var i = 0; i < reviewFakeImageArrayNumber; i++){
			$("#reviewImages").append("<img src='/udongca_project/images/" + reviewFakeImageArray[i] + "' class='image" + i + "'width='40%'>");
...
<form action="/udongca_project/review/reviewModify.udc" enctype="multipart/form-data" method="post" onsubmit="return checkSubmit();">
	...
	<div class="div">
		<table>
			...
			<tr>
				<td class="text">*내용</td>
				<td><textarea rows="30" name="reviewContent" id="reviewContent">${requestScope.review.reviewContent}</textarea></td>
				<td id="reviewContentTd"></td>
			</tr>
			<tr>
				<td class="text">기존 이미지</td>
				<td id="reviewImages" style="padding:20px;width:100%;"></td>
				<td></td>
			</tr>
			<tr>
				<td class="text">추가 이미지</td>
				<td><input type="file" name="addReviewImage" multiple="multiple" style="width:100px;"></td>
				<td></td>
			</tr>
		</table>
	</div>
